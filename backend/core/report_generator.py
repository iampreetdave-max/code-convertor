    ...
    <div class="container">
        ...
        <div class="header-info">
            <div class="info-card">
                ...
                <div class="value">{self._escape_html(report.source_language.upper())}</div>
            </div>
            <div class="info-card">
                <h3>Target Language</h3>
                <div class="value">{self._escape_html(report.target_language.upper())}</div>
            </div>
            <div class="info-card">
        ...
        <div class="footer">
            <p>Generated by Code Converter | Conversion Method: {self._escape_html(report.conversion_method.upper())}</p>
        </div>
    </div>
</body>
</html>"""
